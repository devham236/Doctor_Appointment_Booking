    ...
    return (
        <div className=' mx-auto p-3 lg:p-5'>
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
                ...
                <button className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none' onClick={()=> handleClick(name)}>
                    <MdCall className="group-hover:text-white w-6 h-5  " />
                </button> 
            </div>
        </div>
    )
